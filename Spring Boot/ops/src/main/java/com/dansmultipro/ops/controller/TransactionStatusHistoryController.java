...
public class TransactionStatusHistoryController {
    ...
    @GetMapping
    public ResponseEntity<List<TransactionStatusHistoryResponseDto>> getAllStatusHistories() {
        List<TransactionStatusHistoryResponseDto> res = transactionStatusHistoryService.getAll();
        return new ResponseEntity<>(res, HttpStatus.OK);
    }

    @GetMapping("{id}")
    public ResponseEntity<TransactionStatusHistoryResponseDto> getStatusHistoryById(@PathVariable String id) {
        TransactionStatusHistoryResponseDto res = transactionStatusHistoryService.getById(id);
        return new ResponseEntity<>(res, HttpStatus.OK);
    }
