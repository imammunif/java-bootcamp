...
CREATE TABLE t_assignment (
	...
	target_location_id VARCHAR(36) NOT NULL REFERENCES t_m_location(id),
	target_asset_id VARCHAR(36) NOT NULL REFERENCES t_asset(id),
	target_employee_id VARCHAR(36) NOT NULL REFERENCES t_employee(id),
...
INSERT INTO t_employee (version, created_by, created_at, id, fullname, company_id, birth_date, address, phone, code) VALUES
...
INSERT INTO t_user (version, created_by, created_at, id, role_id, employee_id, email, username, password) VALUES
(0, uuid_generate_v4(), NOW(), uuid_generate_v4(), (SELECT id FROM t_m_role WHERE code = 'RSA01'), (SELECT id FROM t_employee WHERE code = 'EMP001'), 'admin@company.com', 'admin', 'hashed_pass_1'),
(0, uuid_generate_v4(), NOW(), uuid_generate_v4(), (SELECT id FROM t_m_role WHERE code = 'RAM01'), (SELECT id FROM t_employee WHERE code = 'EMP002'), 'jane@company.com', 'janesmith', 'hashed_pass_2'),
(0, uuid_generate_v4(), NOW(), uuid_generate_v4(), (SELECT id FROM t_m_role WHERE code = 'RAM01'), (SELECT id FROM t_employee WHERE code = 'EMP003'), 'alice@company.com', 'alicej', 'hashed_pass_3'),
(0, uuid_generate_v4(), NOW(), uuid_generate_v4(), (SELECT id FROM t_m_role WHERE code = 'RAM01'), (SELECT id FROM t_employee WHERE code = 'EMP004'), 'bob@company.com', 'bobw', 'hashed_pass_4'),
(0, uuid_generate_v4(), NOW(), uuid_generate_v4(), (SELECT id FROM t_m_role WHERE code = 'RAM01'), (SELECT id FROM t_employee WHERE code = 'EMP005'), 'charlie@company.com', 'charlieb', 'hashed_pass_5');

INSERT INTO t_asset (version, created_by, created_at, id, name, company_id, category_id, status_id, exp_date, code) VALUES
(0, uuid_generate_v4(), NOW(), uuid_generate_v4(), 'MacBook Pro 14', (SELECT id FROM t_m_company LIMIT 1), (SELECT id FROM t_m_asset_category WHERE code = 'GENER'), (SELECT id FROM t_m_asset_status WHERE code = 'ARCHV'), NULL, 'AST01'),
...
INSERT INTO t_assignment (version, created_by, created_at, id, assign_date, target_location_id, target_asset_id, target_employee_id) VALUES
(0, uuid_generate_v4(), NOW(), uuid_generate_v4(), NOW(), (SELECT id FROM t_m_location LIMIT 1), (SELECT id FROM t_asset LIMIT 1), (SELECT id FROM t_employee LIMIT 1)),
(0, uuid_generate_v4(), NOW(), uuid_generate_v4(), NOW(), (SELECT id FROM t_m_location OFFSET 1 LIMIT 1), (SELECT id FROM t_asset OFFSET 1 LIMIT 1), (SELECT id FROM t_employee OFFSET 1 LIMIT 1)),
(0, uuid_generate_v4(), NOW(), uuid_generate_v4(), NOW(), (SELECT id FROM t_m_location OFFSET 2 LIMIT 1), (SELECT id FROM t_asset OFFSET 2 LIMIT 1), (SELECT id FROM t_employee OFFSET 2 LIMIT 1)),
(0, uuid_generate_v4(), NOW(), uuid_generate_v4(), NOW(), (SELECT id FROM t_m_location OFFSET 3 LIMIT 1), (SELECT id FROM t_asset OFFSET 3 LIMIT 1), (SELECT id FROM t_employee OFFSET 3 LIMIT 1)),
(0, uuid_generate_v4(), NOW(), uuid_generate_v4(), NOW(), (SELECT id FROM t_m_location OFFSET 4 LIMIT 1), (SELECT id FROM t_asset OFFSET 4 LIMIT 1), (SELECT id FROM t_employee OFFSET 4 LIMIT 1));

INSERT INTO t_assignment_detail (version, created_by, created_at, id, assignment_id, asset_id, return_date) VALUES
(0, uuid_generate_v4(), NOW(), uuid_generate_v4(), (SELECT id FROM t_assignment LIMIT 1), (SELECT id FROM t_asset LIMIT 1), NULL),
(0, uuid_generate_v4(), NOW(), uuid_generate_v4(), (SELECT id FROM t_assignment OFFSET 1 LIMIT 1), (SELECT id FROM t_asset OFFSET 1 LIMIT 1), NULL),
(0, uuid_generate_v4(), NOW(), uuid_generate_v4(), (SELECT id FROM t_assignment OFFSET 2 LIMIT 1), (SELECT id FROM t_asset OFFSET 2 LIMIT 1), '2024-12-01'),
(0, uuid_generate_v4(), NOW(), uuid_generate_v4(), (SELECT id FROM t_assignment OFFSET 3 LIMIT 1), (SELECT id FROM t_asset OFFSET 3 LIMIT 1), NULL),
(0, uuid_generate_v4(), NOW(), uuid_generate_v4(), (SELECT id FROM t_assignment OFFSET 4 LIMIT 1), (SELECT id FROM t_asset OFFSET 4 LIMIT 1), NULL);
