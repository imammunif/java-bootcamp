...
CREATE TABLE t_study_result_detail (
	id SERIAL PRIMARY KEY,
	course_sheet_id INT REFERENCES t_study_result (id),
	study_course_id INT REFERENCES t_study_course (id),
	grade DECIMAL(3, 2)
);
...
INSERT INTO t_semester(period, semester)
VALUES
   	('ganjil', 1),
    ('genap', 2),
    ('ganjil', 3),
...
INSERT INTO t_academic_year(year_end, year_start, semester_id)
VALUES
	('2022-09-01', '2023-01-31', 1),
	('2023-02-01', '2023-08-31', 2),
	('2023-09-01', '2024-01-31', 3),
	('2024-02-01', '2024-08-31', 4),
	('2024-09-01', '2025-01-31', 5),
	('2025-02-01', '2025-08-31', 6),
	('2025-09-01', '2026-01-31', 7),
	('2026-02-01', '2026-08-31', 8);
...
INSERT INTO t_study_course (course_code, course_name, credit, lecture_id)
VALUES
	('ESY514001', 'Ekonometrika', 3, 1),
	('ESY514002', 'Ekonomi Mikro dan Makro', 3, 1),
	('ESY514003', 'Manajemen Keuangan Islam', 3, 1),
	('ESY514004', 'Pemikiran Ekonomi Islam', 3, 1),
	('ESY524012', 'Analisis Laporan Keuangan', 3, 1),
	('ESY514005', 'Fiqh Ekonomi dan Bisnis Islam (FEBI)', 3, 1),
	('ESY514006', 'Manajemen Lembaga Keuangan Syariah', 3, 1),
	('ESY514007', 'Metodologi Penelitian Ekonomi Islam', 3, 1),
	('ESY514008', 'Produk dan Industri Halal', 3, 1),
	('ESY514014', 'Ekonomi Pembangunan Islam', 3, 1),
	('ESY524017', 'Manajemen Keuangan Internasional', 3, 1),
	('ESY514018', 'Seminar Penelitian', 3, 1);
...
INSERT INTO t_study_result_detail (course_sheet_id, study_course_id, grade)
VALUES
	(1, 1, 3.75),
	(1, 2, 3.50),
	(1, 3, 3.80),
